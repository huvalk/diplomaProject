...
type UseCase interface {
	...
	// Оповещение о завершении евента
	SendEventFinishedNotification(users []int, evtID int) error
	// Оповещение о награждении победителей
	SendEventWinnersNotification(users []int, evtID int) error
